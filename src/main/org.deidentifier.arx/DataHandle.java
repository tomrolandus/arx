...
public abstract class DataHandle {
    ...
    public void     writeDataToJSON(String filename){
        if(filename == "default"){
            filename = "/Users/tomrolandus/Dropbox/UB/Master Project/smooth-master/smooth-front-end/src/records";
        }
        int row = 0;
        ...
        for (Iterator<String[]> iter = iterator(); iter.hasNext(); ) {
            ...
            if (row != 0){
                ...
                obj.put("key",String.valueOf(row));
                for (int i = 0; i < this.header.length; i++) {
                    obj.put(this.header[i], record[i]);
                }
                list.add(obj);
            }
            row += 1;
    ...
    public void writeHeaderToJSON(String filename){
        if(filename == "default"){
            filename = "/Users/tomrolandus/Dropbox/UB/Master Project/smooth-master/smooth-front-end/src/header";
        }
        List < Map < String, String >> list = new ArrayList < > ();
