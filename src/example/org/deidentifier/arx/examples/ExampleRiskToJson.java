 ...
 */
public class ExampleRiskToJson extends Example {
    ...
    public static void main(String[] args) throws IOException {
        ...
        result.getOutput().getRiskEstimator(populationmodel).getSampleBasedReidentificationRisk().printMixedRisksJSON("risks1");
        result.getOutput().getRiskEstimator(populationmodel).getSampleBasedRiskDistribution().printHistogramValuesJSON("riskDistributionValues");
    }
}
