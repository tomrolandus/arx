...
import org.deidentifier.arx.certificate.RiskReport;
 ...
 */
public class Example_risk_report extends Example {
    ...
    public static void main(String[] args) throws ParseException, IOException, NoSuchAlgorithmException {
        ...
        // Create certificate
        RiskReport certificate = RiskReport.create(data.getHandle(), data.getDefinition(),
